...
function filterBy(SliderValue){
    ...
    //translates the range slider steps to dates 
         if (slider == 1) {datephotos = "2018-04-06"; dateroutes = "20180407";}
    else if (slider == 2) {datephotos = "2018-04-07"; dateroutes = "20180408";}
    else if (slider == 3) {datephotos = "2018-04-08"; dateroutes = "20180409";}
    else if (slider == 4) {datephotos = "2018-04-09"; dateroutes = "20180410";}
    else if (slider == 5) {datephotos = "2018-04-10"; dateroutes = "20180411";}
    else if (slider == 6) {datephotos = "2018-04-11"; dateroutes = "20180412";}
    else if (slider == 7) {datephotos = "2018-04-12"; dateroutes = "20180413";}
    else if (slider == 8) {datephotos = "2018-04-13"; dateroutes = "20180414";}
    else if (slider == 9) {datephotos = "2018-04-14"; dateroutes = "20180415";}
    else if (slider == 10) {datephotos = "2018-04-15"; dateroutes = "20180416";}
